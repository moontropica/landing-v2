...
description: "The CAH bonding multiplier moves from 2.0x to 1.3x. Here's why that's a net positive for Moon Tropica, the crypto space, and everything we've built to get here."
date: 2026-08-10
tags: ["announcements"]
...
The Gnosis Safe has updated `discountBps` from **10000 to 3000**, moving the bonding multiplier from **2.0x to 1.3x**.
...
<table>
  ...
  <tbody>
    <tr><td>discountBps</td><td>10000</td><td>3000</td></tr>
    <tr><td>Multiplier</td><td>2.0x</td><td>1.3x</td></tr>
    <tr><td>$1,000 LP → bonus</td><td>$2,000 CAH</td><td>$1,300 CAH</td></tr>
  </tbody>
</table>

</div>

This wasn't an emergency change — it's a milestone. The protocol has proven itself stable since launch, the bonding system is running smoothly, and early bonders were properly rewarded at the 2.0x rate. As the pool deepens and the system matures, the incentive naturally tapers. That's how sustainable tokenomics work.
...
**Slower dilution.** Every bond mints less CAH into circulation than it did at 2.0x. The 8.75M CAH reward pool stretches further. More bonds can happen before the pool dries up. That means more total protocol-owned liquidity over the pool's lifetime — not just a fast sprint and an empty tank.
...
The protocol is in soft-launch. Bonding is live. The frontend is deployed. The contracts are verified. The multisig is active.
