...
const tones: Record<Tone, string> = {
  default:
    "bg-gradient-to-b from-white/[.04] to-white/[.02] border border-white/[.08] rounded-r-lg p-6",
  purple:
    "bg-[linear-gradient(160deg,var(--color-mt-purple-500),var(--color-mt-purple-600))] " +
    "rounded-r-lg p-7 shadow-purple-glow",
  dark: "bg-mt-ink-700 border border-white/[.05] rounded-r-lg p-6",
};
